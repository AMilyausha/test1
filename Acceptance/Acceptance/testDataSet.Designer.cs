...
namespace Acceptance {
    ...
    public partial class testDataSet : global::System.Data.DataSet {
        ...
        public partial class providerDataTable : global::System.Data.TypedTableBase<providerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public providerRow AddproviderRow(int code, string name) {
        ...
        public partial class providerRow : global::System.Data.DataRow {
            ...
            public int code {
                get {
                    try {
                        return ((int)(this[this.tableprovider.codeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'code\' в таблице \'provider\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Acceptance.testDataSetTableAdapters {
    ...
    public partial class providerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[provider] WHERE (([id] = @Original_id) AND ((@IsNull_code = 1 " +
                "AND [code] IS NULL) OR ([code] = @Original_code)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[provider] ([code], [name]) VALUES (@code, @name);\r\nSELECT id, " +
                "code, name FROM provider WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[provider] SET [code] = @code, [name] = @name WHERE (([id] = @Origin" +
                "al_id) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)))" +
                ";\r\nSELECT id, code, name FROM provider WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, code, name FROM dbo.provider";
        ...
        public virtual int Update(global::System.Nullable<int> code, string name, int Original_id, global::System.Nullable<int> Original_code, int id) {
            if ((code.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> code, string name, int Original_id, global::System.Nullable<int> Original_code) {
