...
namespace Acceptance {
    ...
    public partial class testDataSet2 : global::System.Data.DataSet {
        ...
        public partial class invoiceDataTable : global::System.Data.TypedTableBase<invoiceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public invoiceRow AddinvoiceRow(string product, string price, string count) {
        ...
        public partial class invoiceRow : global::System.Data.DataRow {
            ...
            public string product {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'product\' в таблице \'invoice\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string price {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'price\' в таблице \'invoice\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string count {
                get {
                    try {
                        return ((string)(this[this.tableinvoice.countColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'count\' в таблице \'invoice\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableinvoice.countColumn] = value;
                }
            }
            ...
            public bool IscountNull() {
                return this.IsNull(this.tableinvoice.countColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetcountNull() {
                this[this.tableinvoice.countColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Acceptance.testDataSet2TableAdapters {
    ...
    public partial class invoiceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[invoice] ([product], [price], [count]) VALUES (@product, @pric" +
                "e, @count);\r\nSELECT id, product, price, count FROM invoice WHERE (id = SCOPE_IDE" +
                "NTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[invoice] SET [product] = @product, [price] = @price, [count] = @cou" +
                "nt WHERE (([id] = @Original_id));\r\nSELECT id, product, price, count FROM invoice" +
                " WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, product, price, count FROM dbo.invoice";
        ...
        public virtual int Fill(testDataSet2.invoiceDataTable dataTable) {
        ...
        public virtual testDataSet2.invoiceDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            testDataSet2.invoiceDataTable dataTable = new testDataSet2.invoiceDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(testDataSet2.invoiceDataTable dataTable) {
        ...
        public virtual int Insert(string product, string price, string count) {
            if ((product == null)) {
        ...
        public virtual int Update(string product, string price, string count, int Original_id, int id) {
            if ((product == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string product, string price, string count, int Original_id) {
            return this.Update(product, price, count, Original_id, Original_id);
        }
    }
